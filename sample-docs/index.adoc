...
Doc docref:documentw[version=v2.9] asdasd

Doc docref:ifcmas[version=v2.2] asdasd

Ref to previously mentioned doc Doc docref:anotherdoc[version=v2.9] asdasd
